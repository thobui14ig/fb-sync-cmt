...
export class GetCommentPublicUseCase {
    ...
    async getCmtPublic(postId: string, isCheckInfoLink: boolean = false, link?: LinkEntity): Promise<IGetCmtPublicResponse | null> {
        ...
        try {
            ...
            if (postId === '122128358660803341') console.log("🚀 ~ GetCommentPublicUseCase ~ getCmtPublic ~ duration:", duration)
            ...
            if (postId === '122128358660803341') console.log("🚀 ~ GetCommentPublicUseCase ~ getCmtPublic ~ dataComment:", dataComment)
            ...
            if (dataComment) {
                ...
                console.log("🚀 ~ GetCommentPublicUseCase ~ getCmtPublic ~ isExistKey:", isExistKey)
                if (!isExistKey) {
                    return {
                        hasData: true,
                        data: dataComment
